...
int main() {
    ...
    printf("Enter record number to write (1-3): ");
    scanf("%d", &rno);
    rno--;
...
/*
============================================================================
bhautik@bhautik:~/SS/MT2025029/18$ gcc 18b.c
bhautik@bhautik:~/SS/MT2025029/18$ ./a.out
Enter record number to write (1-3): 2
Write lock acquired on record 2
inside the critical section...
Enter new data: MT2025010 Abhishek 23
